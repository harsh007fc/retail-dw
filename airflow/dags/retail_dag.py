...
# # Add your scripts directory to the Python path
# sys.path.insert(0, os.path.expanduser("~dw/scripts"))
...
# script1_path = os.path.join(project_root, "dw/scripts/data_generator/generator.py")
# script2_path = os.path.join(project_root, "dw/scripts/lambda_function/json_to_parquet.py")
...
#     "retail_dag_bash",
#     default_args=default_args,
#     description="Run two jobs sequentially using BashOperator",
#     schedule=timedelta(days=1),  # Runs daily
#     start_date=datetime(2024, 1, 1),
#     catchup=False,
#     tags=["jobs"],
...
#         task_id="run_job1",
#         bash_command=f"python {script1_path}",
#     )

#     run_job2 = BashOperator(
#         task_id="run_job2",
#         bash_command=f"python {script2_path}",
#     )
